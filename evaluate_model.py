...
def main():
    ...
    '''
    parameter_names = ['lr_in_0.5-lr_var_0.001-lr_out_0.001', 'lr_in_0.1-lr_var_0.001-lr_out_0.0001', 'lr_in_0.01-lr_var_0.001-lr_out_0.01']
    label_names = [r'$\lambda=0.5, \theta=0.001, w=0.001$', r'$\lambda=0.1, \theta=0.001, w=0.0001$', r'$\lambda=0.01, \theta=0.001, w=0.01$']
